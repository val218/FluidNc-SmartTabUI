...
void tabui_setTheme(int t) {
    ...
    switch (t) {
        ...
        case 2:  // Light — light blue backgrounds, near-black text
            COL_BG=0xEF9F; COL_PANEL=0xD73F; COL_PANEL2=0xBE9E; COL_PANEL3=0xDF5F;
            COL_BORDER=0x95DB; COL_BORDER2=0x64B9; COL_DIM=0x2965; COL_DIM2=0x1082;
            COL_WHITE=0x0841; COL_WHITE2=0x1906;
            COL_AX_X=0x8800; COL_AX_Y=0x0480; COL_AX_Z=0x8200; COL_AX_A=0x6000; break;

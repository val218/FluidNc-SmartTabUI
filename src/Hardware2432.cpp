...
static void init_capacitive_cyd() {
    ...
    // MPG encoder — A on GPIO16, B on GPIO4 (dedicated pins, no conflicts)
    enc_a = GPIO_NUM_16;
    enc_b = GPIO_NUM_4;

    // Step switch: pos2=GPIO22(1mm), pos3=GPIO21(10mm), pos1=NC(0.1mm)
    // Axis switch: pos2=GPIO17(X), pos3=GPIO35(Y), pos4=GPIO21(Z), pos5=GPIO22(A), pos1=NC(off)
    // NOTE: GPIO21/22 now purely switch inputs — no PCNT conflict
